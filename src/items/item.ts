...
export abstract class Item extends THREE.Mesh {
   ...
   * @param scale TODO
   */
  constructor(protected model: any, public metadata: Metadata, geometry: THREE.BufferGeometry, material: THREE.Material | THREE.Material[], position: THREE.Vector3, rotation: number, scale: THREE.Vector3) {
    super();
  ...
  public updateHighlight() {
    ...
    var mats = Array.isArray(this.material) ? this.material : [this.material];
